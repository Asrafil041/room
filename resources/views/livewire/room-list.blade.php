        ...
        @foreach($rooms as $room)
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition duration-300 overflow-hidden">
                <div class="p-5">
                    ...
                    <a href="{{ route('room.detail', $room->id) }}" wire:navigate class="block w-full text-center bg-gray-800 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded-lg transition duration-150">
